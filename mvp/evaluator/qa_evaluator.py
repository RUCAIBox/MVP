...
class QAEvaluator(AbstractEvaluator):
    ...
    def evaluate(self, generate_corpus, reference_corpus):
        with open('dataset/squad/dev-v1.1.json') as dataset_file:
            dataset_json = json.load(dataset_file)
            dataset = dataset_json['data']
        with open('dataset/squad/dev.id') as f:
            pids = f.readlines()
        preds = {}
        for pre, id in zip(generate_corpus, pids):
            preds[eval(id.strip())] = ' '.join(pre)
